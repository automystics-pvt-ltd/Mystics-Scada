...
with open('artifacts/solar-scada/src/pages/superadmin-notifications.tsx', 'r') as f:
    content = f.read()
...
with open('artifacts/solar-scada/src/pages/superadmin-notifications.tsx', 'w') as f:
    f.write(content)
